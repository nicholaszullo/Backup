...
public class Assig3
{
	public static void main(String [] args)
	{
		...
		System.out.println(b1);
//		b1.replace(0,4, "");					//Special case empty string
//		System.out.println(b1);
		...
		// specifications.
		String patA = "ABC123XYZ";//		String patA = "ABC"
		String patB = "123";
		String patC = "XYZ";
		String [] patterns = { patA, patB, patC };
		MyStringBuilder2 B = new MyStringBuilder2("BBB222YYYCCC");//		MyStringBuilder2 B = new MyStringBuilder2("**BBB22AAYYCC3ZZZ**");
